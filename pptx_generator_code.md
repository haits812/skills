...
以下のPythonコードをファイルとして保存し、`SLIDES_TO_USE`と`SLIDE_CONTENT`を編集して実行する。

```python
"""
PPTX Generator - 1ファイル完結型スライド生成
"""
...
def create_timeline(slide, data, theme):
    ...
    timeline_items = data.get('timeline_items', [
        {"year": "2021", "title": "Phase 1", "description": "説明文"},
        {"year": "2022", "title": "Phase 2", "description": "説明文"},
        {"year": "2023", "title": "Phase 3", "description": "説明文"},
        {"year": "2024", "title": "Phase 4", "description": "説明文"},
    ])
    timeline_colors = [
...
# ============================================================
SLIDE_TEMPLATES = {
    1: {"name": "表紙", "template": "cover", "default_data": {"title": "", "subtitle": "", "credit": ""}},
    2: {"name": "目次", "template": "list", "default_data": {"title": "", "subtitle": "", "items": []}},
    3: {"name": "左グラフ・右テキスト（棒）", "template": "chart_left_text_right", "default_data": {"title": "", "subtitle": "", "chart_type": "COLUMN_CLUSTERED", "categories": [], "series": [], "text_items": []}},
    4: {"name": "左テキスト・右グラフ（円）", "template": "text_left_chart_right", "default_data": {"title": "", "subtitle": "", "chart_type": "PIE", "categories": [], "series": [], "text_items": []}},
    5: {"name": "左テーブル・右テキスト", "template": "table_left_text_right", "default_data": {"title": "", "subtitle": "", "columns": [], "rows": [], "text_items": []}},
    6: {"name": "左テキスト・右グラフ（線）", "template": "text_left_chart_right", "default_data": {"title": "", "subtitle": "", "chart_type": "LINE", "categories": [], "series": [], "text_items": []}},
    7: {"name": "カードグリッド", "template": "card_grid", "default_data": {"title": "", "subtitle": "", "items": []}},
    8: {"name": "左テキスト・右画像", "template": "text_left_image_right", "default_data": {"title": "", "subtitle": "", "text_items": []}},
    9: {"name": "3ポイント", "template": "three_points_circle", "default_data": {"title": "", "subtitle": "", "items": []}},
    10: {"name": "ポイントリスト（小）", "template": "point_list_compact", "default_data": {"title": "", "subtitle": "", "items": []}},
    11: {"name": "ポイントリスト（大）", "template": "point_list_large", "default_data": {"items": []}},
    12: {"name": "タイムライン", "template": "timeline", "default_data": {"title": "", "subtitle": "", "timeline_items": []}},
}
...
# ★ 各スライドの内容 ★
SLIDE_CONTENT = {
    1: {"title": "サンプルタイトル", "subtitle": "Sample Presentation", "credit": "2025.01.20 | 会社名"},
    2: {"title": "目次", "subtitle": "Agenda", "items": ["項目1", "項目2", "項目3"]},
    3: {"title": "売上推移", "subtitle": "Sales", "chart_type": "COLUMN_CLUSTERED", "categories": ["Q1", "Q2", "Q3", "Q4"], "series": [{"name": "2024", "values": [100, 120, 140, 160]}], "text_items": ["ポイント1", "ポイント2"]},
    4: {"title": "結び", "subtitle": "Closing", "credit": "ご清聴ありがとうございました"},
}
...
def build_slide_data(output_index: int, slide_id: int) -> dict:
    ...
    return {"template": template_info.get('template', 'cover'), "template_name": template_info.get('name', '不明'), "data": merged_data}
...
def generate_presentation(output_path="output.pptx"):
    ...
    for output_index, slide_id in enumerate(SLIDES_TO_USE, start=1):
        ...
        print(f"  [{output_index}] {slide_info['template_name']}: {data.get('title', '(なし)')}")
